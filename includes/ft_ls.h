...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/11/13 18:26:11 by pnunez            #+#    #+#             */
/*   Updated: 2019/11/13 18:34:56 by pnunez           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			init_program(int ac, char **avl);
...
void			sort_folders(char **folders, t_flags *flags,
					int num_of_folders);
...
int				totaldirs(char **folder, t_flags *flags,
...
int				print_chr_blk(struct stat *filestats, struct passwd *psswd,
					struct group *grp);
void			continue_chr_print(struct stat *filestats,
					char *tmp, char *name);
...
void			start_output(DIR *directory_stream,
					t_info *program_info, int i);
